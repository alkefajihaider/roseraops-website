...
const PETALS = [
  { left: '6%', delay: '0s', duration: '17s', scale: 0.8, color: 'var(--p-rose)' },
  { left: '18%', delay: '5s', duration: '21s', scale: 1.05, color: 'var(--p-sage)' },
  { left: '31%', delay: '11s', duration: '19s', scale: 0.7, color: 'var(--p-gold)' },
  { left: '44%', delay: '2s', duration: '23s', scale: 0.95, color: 'var(--p-rose)' },
  { left: '57%', delay: '8s', duration: '18s', scale: 0.75, color: 'var(--p-sage)' },
  { left: '69%', delay: '14s', duration: '22s', scale: 1.1, color: 'var(--p-clay)' },
  { left: '81%', delay: '4s', duration: '20s', scale: 0.85, color: 'var(--p-rose)' },
  { left: '92%', delay: '9s', duration: '24s', scale: 0.7, color: 'var(--p-gold)' },
];
